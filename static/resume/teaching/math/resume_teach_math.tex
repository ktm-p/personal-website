...
%	\resumeItemListStart
%	\resumeItemTwo{Proof Techniques, Graph Theory, Number Theory, Combinatorics, and Probability Theory.}
%	\resumeItemListEnd
...
%	\resumeItemListStart
%	\resumeItemTwo{Matrices, Vector Spaces, Linear Transformations, Inner Products, Eigenvectors, and Jordan Canonical Forms.}
%	\resumeItemListEnd
	
	\resumeSubheadingFour{Math 113: Abstract Algebra}
%	\resumeItemListStart
%	\resumeItemTwo{Groups, (Commutative) Rings, Ideals, Quotient Fields, Polynomials, Fields, and Field Extensions.}
%	\resumeItemListEnd
	\resumeSubHeadingListEnd
