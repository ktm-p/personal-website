            ...
            <div className="background">
                <div className="background-left">
                    <p>
                        ...
                        Anyways, to the right, you can see all of the countries that I've been to. Right now, most of the map is pretty blank, but hopefully things will change soon... <span style={{fontSize: "0.25rem"}}>hopefully...</span>
                    </p>
                </div>
            ...
            <div className="background">
                <div className="background-left">
                    <p>
                        ...
                        Anyways, to the right, you can see all the countries I've been to. Right now, most of the map is blank, but hopefully things will change soon... <span style={{fontSize: "0.25rem"}}>hopefully...</span>
                    </p>
                </div>
                <div className="background-right">
                    Placeholder.
