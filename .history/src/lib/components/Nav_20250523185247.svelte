...
<nav style="position: sticky; top: 0px;" id="nav-bar">
    ...
    <div class={`nav-links ${showMenu ? 'show' : ''}`} style="margin-left: 60%; margin-right: 10px; position: absolute;">
    ...
    <div class="darkmode_toggle" style="margin-left: 96%; position: absolute;">
