    ...
    <div class="project-desc">
        ...
        <div class="project-text">
            <p>
                ...
                Using information from the FFT, I created 3D objects which generate, move, and change colors according to the audio's frequencies. Additionally, I created a fluctuating polar graph where each point is mapped to a frequency value. Finally, at the bottom of the screen is a 3D Terrain made using Perlin Noise that's responsive to the audio. A demo is available <a href="https://youtu.be/7KIApzMEXdQ">here <sup><i class='fas fa-external-link-alt arrow'></i></sup></a>.
            </p>
        </div>
