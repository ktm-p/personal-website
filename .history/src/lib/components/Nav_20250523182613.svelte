...
<nav style="position: sticky; top: 0px;" id="nav-bar">
    ...
    <div class={`nav-links ${showMenu ? 'show' : ''}`} style="margin-right: 0;">
        ...
        <a class={`nav-link ${currentPath.startsWith('/blog') ? 'current' : ''}`} href="/blog" style="margin-right: 0;">Blog</a>
    </div>
    <div class="darkmode_toggle" style="margin-left: 0; gap: 0">
