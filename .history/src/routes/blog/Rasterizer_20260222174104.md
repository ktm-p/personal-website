...
Below, we provide images of the two different sampling methods. First, we show pictures of nearest and bilinear respectively, both with a rate of $r = 1$:
...
Next, we have nearest and bilinear with rate $r = 16$:
