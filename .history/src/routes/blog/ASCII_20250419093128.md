...
One na\"ive way to fix this is by simply eyeballing the space, and changing the aspect ratio of our ASCII art to accomodate these gaps. While doing this, we can also implement a resizing function so we don't have a massive 512x512 image that we have to zoom out fully to appreciate:
```python
