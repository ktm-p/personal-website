...
The set of linearly independent vectors which spans our lattice is called the basis. Note that $\mathcal L$ can have infinitely many bases! However, some bases are "better" than others for our 
