---
title: Writing an ASCII Image Generator
...
For the rest of this post, I'll be detailing how I went about creating an image-to-ASCII converter, along with further improvements and optimizations done to the na&iumlve implementation. This includes adding in colour, speeding up the implementation, and also introducing edge detection to further refine the output.
