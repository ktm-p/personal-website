...
date: '2026-02-21'
description: Walking through building a simple rasterizer.
---
...
![Naïve Implementation on basic/test4.svg](/blog/rasterizer/1/fig_1.png "Figure 1.1: Naïve Implementation on basic/test4.svg")
...
![Sampling Rate of 1](/blog/rasterizer/2/fig_1.png "Figure 2.1: Sampling Rate of 1.")

![Sampling Rate of 4](/blog/rasterizer/2/fig_2.png "Figure 2.2: Sampling Rate of 4.")

![Sampling Rate of 9](/blog/rasterizer/2/fig_3.png "Figure 2.3: Sampling Rate of 9.")

![Sampling Rate of 16](/blog/rasterizer/2/fig_4.png "Figure 2.4: Sampling Rate of 16.")
...
![Degenerate Square with Sampling Rate of 1](/blog/rasterizer/2/fig_5.png "Figure 2.5: Degenerate Square with Sampling Rate of 1.")

![Degenerate Square with Sampling Rate of 16](/blog/rasterizer/2/fig_6.png "Figure 2.6: Degenerate Square with Sampling Rate of 16.")
...
![Jittering with Sampling Rate of 1](/blog/rasterizer/2/fig_7.png "Figure 2.7: Jitter Sampling with Sampling Rate of 1.")

![Jittering with Sampling Rate of 16](/blog/rasterizer/2/fig_8.png "Figure 2.8: Jitter Sampling with Sampling Rate of 16.")
...
![Default Robot](/blog/rasterizer/3/fig_1.png "Figure 3.1: Default Robot")

And using these functions, we can make it look like the robot is praising the sun:

![Praising the Sun](/blog/rasterizer/3/fig_2.png "Figure 3.2: Robot Praising the Sun.")
...
![GUI Rotation](/blog/rasterizer/3/fig_3.png "Figure 3.3: Robot Rotated 90 Degrees Right.")
...
![Coloured Triangle](/blog/rasterizer/4/fig_1.png "Figure 4.1: Intuition for Barycentric Coordinates.")
...
![basic/test7.svg](/blog/rasterizer/4/fig_2.png "Figure 4.2: Image of test7.svg.")
...
- Bilinear: For this, we first get the four closest points to our current pixel $p$. Then, we perform bilinear interpolation in order to calculat the final colour needed. Although the result is smoother, it is more computationally expensive.

Below, we provide images of the two different sampling methods. First, we have nearest sampling with $r=1$:

![Nearest with Rate 1](/blog/rasterizer/5/fig_1.png "Figure 5.1: Nearest Sampling with Rate 1.")

Next, we have bilinear sampling with $r=1$:

![Bilinear with Rate 1](/blog/rasterizer/5/fig_2.png "Figure 5.2: Nearest Sampling with Rate 1.")

Now, we have nearest with rate $r = 16$:

![Nearest with Rate 16](/blog/rasterizer/5/fig_3.png "Figure 5.3: Nearest Sampling with Rate 16.")

And finally, bilinear with $r = 16$:

![Bilinear with Rate 16](/blog/rasterizer/5/fig_4.png "Figure 5.4: Bilinear Sampling with Rate 16.")

We notice how with nearest sampling, it fails to capture some of the white lines that bilinear sampling does. We also note that with nearest sampling, jaggies are more apparent (at least with the $r = 1$ case). The differences between them will be most apparent in situations where the pattern changes often, as bilinear sampling takes into account neighbours whereas nearest sampling doesn't.
...
$$
    \begin{equation*}
        D = \log_2\left(\mathrm{max}\left( \sqrt{\left( \frac{du}{dx} \right)^2 + \left( \frac{du}{dy} \right)^2 },  \sqrt{\left( \frac{dv}{dx} \right)^2 + \left( \frac{dv}{dy} \right)^2 }\right)\right)
    \end{equation*}
$$
...
![L_ZERO and P_NEAREST](/blog/rasterizer/6/fig_1.png "Figure 6.1: L_ZERO and P_NEAREST.")
...
![L_LINEAR and P_NEAREST](/blog/rasterizer/6/fig_2.png "Figure 6.2: L_NEAREST and P_NEAREST.")
...
![L_ZERO and P_LINEAR](/blog/rasterizer/6/fig_3.png "Figure 6.3: L_ZERO and P_LINEAR.")
...
![L_LINEAR and P_LINEAR](/blog/rasterizer/6/fig_4.png "Figure 6.4: L_LINEAR and P_LINEAR.")