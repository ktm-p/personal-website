...
![Example of CVP Instance](/blog/ggh/fig_1.svg "Figure 2: Example of CVP Instance")

As it turns out, without knowing extra information like the basis of $\mathcal L$, it is very difficult to find this closest vector point! As such, it is reasonable that this could serve as the starting point for a encryption scheme; after all, if non-recipients don't have access to the basis, they won't be able to decrypt the message!
