<section class="personal-project">
    ...
    <div class="project-container" id="audio_analyzer">
        <enhanced:img src="$lib/assets/projects/personal/audio_analyzer.png" class="project-img"></enhanced:img>
        <div class="project-desc">
...
<section class="coursework">
    ...
    <div class="project-container" id="byow" style="margin-top: 0.5rem;">
        <enhanced:img src="$lib/assets/projects/coursework/byow_preview.png" class="project-img"></enhanced:img>
        <div class="project-desc">
    ...
    <div class="project-container" id="rl">
        <enhanced:img src="$lib/assets/projects/coursework/rl_preview.png" class="project-img"></enhanced:img>
        <div class="project-desc">
    ...
    <div class="project-container" id="doublependulum">
        <enhanced:img src="$lib/assets/projects/coursework/doublependulum_preview.png" class="project-img"></enhanced:img>
        <div class="project-desc">
